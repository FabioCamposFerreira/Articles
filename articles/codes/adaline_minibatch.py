...
def train(model,x,y,num_epochs,learning_rate=0.01,seed=123,minibatch_size=10):
    ...
    for e in range(num_epochs):
        ...
        for minibatch_index in minibatch:
            ...
            # compute gradients
            negative_gradiente_w,negative_gradiente_b = model.backward(x[minibatch_index],y_hat)
            ...
            # Logging Batchs
            minibatch_loss = loss(y_hat,y[minibatch_index])
            print("     Minibatch MSE: %3.f" % minibatch_loss)
